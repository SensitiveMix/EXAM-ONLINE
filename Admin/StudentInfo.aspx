<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentInfo.aspx.cs" Inherits="ExamOnline.Admin.StudentInfo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <fieldset style="width: 544px; height: 236px">
            ...
            <asp:TextBox ID="txtKey" runat="server" Height="13px"></asp:TextBox>
            ...
            <asp:GridView ID="gvStuInfo" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="StudentNum" DataNavigateUrlFormatString="ChangeStudentInfo.aspx?stuid={0}"
