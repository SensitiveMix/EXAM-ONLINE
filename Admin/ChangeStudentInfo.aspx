<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeStudentInfo.aspx.cs" Inherits="ExamOnline.Admin.ChangeStudentInfo" %>
    ...
    <form id="form1" runat="server">
        ...
        <fieldset style="width: 406px; height: 200px">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" height="186" style="width: 341px">
                ...
                <tr>
                    <td style="text-align: center">&nbsp;考生密码：</td>
                    <td style="text-align: left">
