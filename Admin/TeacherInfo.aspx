<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherInfo.aspx.cs" Inherits="ExamOnline.Admin.TeacherInfo" %>
...
<div style="text-align: center">
        ...
        <asp:GridView ID="gvTeacher" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="TeacherNum" DataNavigateUrlFormatString="TeacherDetailinfo.aspx?Tid={0}"
