<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherDetailinfo.aspx.cs" Inherits="ExamOnline.Admin.TeacherDetailinfo" %>
    ...
    <form id="form1" runat="server">
        ...
        <fieldset style="width: 406px; height: 200px">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" height="186" style="width: 341px">
                <tr>
                    <td style="text-align: center" width="120">&nbsp;教师编号：</td>
                ...
                <tr>
                    <td style="text-align: center">&nbsp;负责课程：</td>
                    <td style="text-align: left">
