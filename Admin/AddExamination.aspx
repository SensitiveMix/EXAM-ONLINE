<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddExamination.aspx.cs" Inherits="ExamOnline.Admin.AddExamination" %>
        ...
        <div style="text-align: center">
            ...
            &nbsp;<fieldset style="width: 454px; height: 335px">
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" style="height: 321px"
                    ...
                    <tr>
                        <td style="text-align: right">&nbsp;试题题目：</td>
                    ...
                    <tr>
                        <td style="height: 27px; text-align: right">&nbsp;正确选项：</td>
