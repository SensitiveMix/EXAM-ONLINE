<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TAddExamination.aspx.cs" Inherits="ExamOnline.Teacher.TAddExamination" %>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" style="height: 321px"
                ...
                <tr>
                    ...
                    <td colspan="2" style="height: 24px; text-align: left">
                        <asp:Label ID="lblkmname" runat="server" Text="Label"></asp:Label></td>
                </tr>
                <tr>
