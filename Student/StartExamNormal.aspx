<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StartExamNormal.aspx.cs" Inherits="ExamOnline.Student.StartExamNormal" %>
        ...
        <div style="text-align: left">
            ...
            <table align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td bgcolor="#ecf9ff" width="352" style="height: 23px">&nbsp;<asp:Button ID="btnsubmit" runat="server" OnClick="btnsubmit_Click" Text="交卷" UseSubmitBehavior="False" />
                    </td>
                </tr>
                <tr>
                    <td colspan="7" height="53">
                        <img height="53" src="../Images/exame_05.gif" width="778" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="457">&nbsp;</td>
                    <td colspan="6" height="457" valign="top">&nbsp;<asp:Panel ID="Panel1" runat="server" Height="50px" Width="547px">
                    </asp:Panel>
                        &nbsp;
                    </td>
                </tr>
